...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.firstName && user.lastName && user.email && user.phone && user.username && user.password && user.confirmpassword) {
        ...
        return (
            <div className="col-md-12 register_block">
                <div className="register_div">
                    <h3 className="mt-0">Register</h3>
                    <form name="form" onSubmit={this.handleSubmit}>
                        <div className={'form-group col-md-6 padl0' + (submitted && !user.firstName ? ' has-error' : '')}>
                        ...
                        <div className={'form-group col-md-6 padr0' + (submitted && !user.lastName ? ' has-error' : '')}>
                        ...
                        <div className={'form-group col-md-6 padl0' + (submitted && !user.password ? ' has-error' : '')}>
                        ...
                        <div className={'form-group col-md-6 padr0' + (submitted && !user.confirmpassword ? ' has-error' : '')}>
                        ...
                        <div className="form-group">
                            ...
                            <div>
                                Already have an account?<Link to="/login" className="btn btn-link">Sign In</Link>
                            </div>
                        </div>
                    </form>
                </div>
